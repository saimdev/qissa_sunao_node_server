...
app.get("/get_all_stories", async (req, res) => {
  try {
...
app.post("/get_single_story", async (req, res) => {
...
app.post("/get_user_favs", async (req, res) => {
  try {
...
app.post("/get_all_voices", async (req, res) => {
  try {
...
app.post("/post_story_api_testing", async (req, res) => {
  try {
...
app.get("/get_random_story", async (req, res) => {
  try {
...
app.post('/get-shared-story', async (req, res) => {
  try {
